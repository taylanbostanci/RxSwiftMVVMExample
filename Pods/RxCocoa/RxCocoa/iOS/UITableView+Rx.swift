    ...
    */
    public func items<
        ...
        return { source in
            ...
            return source.subscribeProxyDataSource(ofObject: self.base, dataSource: dataSource as UITableViewDataSource, retainDataSource: true) { [weak taskTV = self.base] (_: RxTableViewDataSourceProxy, event) -> Void in
                guard let taskTV = taskTV else {
                    return
                }
                dataSource.tableView(taskTV, observedEvent: event)
            }
        }
    }
